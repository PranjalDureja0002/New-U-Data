...
def _render_interactive_chart(plan, columns, rows):
    ...
    html_parts = [
        ...
        f"tooltip:{{callbacks:{{label:function(c){{let v=c.parsed.y!==undefined?c.parsed.y:c.parsed;if(typeof v==='number')return c.dataset.label+': '+v.toLocaleString('en-US',{{maximumFractionDigits:2}});return c.dataset.label+': '+v}}}}}}}},",
        ...
        try:
            ...
            if self.render_mode == "interactive":
                ...
                if iframe:
                    ...
                    return Message(text=iframe + data_comment)
